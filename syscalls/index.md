...
The control goes to the operating system (the kernel) as a result of the `svc` and it executes some piece of code (called the exception handler, more about it in detail [here](https://pyjamacafe.com/posts/arm64-day2-irq-handling/)).
